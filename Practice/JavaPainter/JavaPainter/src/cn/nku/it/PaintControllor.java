...
public class PaintControllor {
	...
	public void reportPenList(LinkedList<Integer> xList,
			LinkedList<Integer> yList) {
		this.xArray = xList.toArray(new Integer[0]);
		this.yArray = yList.toArray(new Integer[0]);
		Vars.paintModel.addShape(new Shape(PaintModel.PEN, shapeColor,  xArray,yArray));
	}
}
